...
function Player() {
  ...
  return /*#__PURE__*/ React.createElement(
    Bounds,
    { fit: true, clip: true, observe: true, margin: 10 } /*#__PURE__*/,
    React.createElement(
      "group",
      { ref: player } /*#__PURE__*/,
      React.createElement(
...
function Row({ rowIndex, rowData }) {
  switch (rowData.type) {
    case "forest": {
      return /*#__PURE__*/ React.createElement(Forest, {
        rowIndex: rowIndex,
        rowData: rowData,
      });
    }
    case "car": {
      return /*#__PURE__*/ React.createElement(CarLane, {
        rowIndex: rowIndex,
        rowData: rowData,
      });
    }
    case "truck": {
      return /*#__PURE__*/ React.createElement(TruckLane, {
        rowIndex: rowIndex,
        rowData: rowData,
      });
    }
...
function Grass({ rowIndex, children }) {
  return /*#__PURE__*/ React.createElement(
    "group",
    { "position-y": rowIndex * tileSize } /*#__PURE__*/,
    React.createElement(
      "mesh",
      { receiveShadow: true } /*#__PURE__*/,
      React.createElement("boxGeometry", {
        args: [tilesPerRow * tileSize, tileSize, 3],
      }) /*#__PURE__*/,
      React.createElement("meshLambertMaterial", {
        color: 0xbaf455,
        flatShading: true,
    ...
    React.createElement(
      ...
      {
        receiveShadow: true,
        "position-x": tilesPerRow * tileSize,
      } /*#__PURE__*/,
      React.createElement("boxGeometry", {
        args: [tilesPerRow * tileSize, tileSize, 3],
      }) /*#__PURE__*/,
...
function Tree({ tileIndex, height }) {
  return /*#__PURE__*/ React.createElement(
    "group",
    { "position-x": tileIndex * tileSize } /*#__PURE__*/,
    React.createElement(
      "mesh",
      {
    ...
    React.createElement(
      "mesh",
      { "position-z": 10, castShadow: true, receiveShadow: true } /*#__PURE__*/,
